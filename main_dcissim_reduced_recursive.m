...
% 状态空间模型
analysis_identified_x_size = size(iden_online_result_struct{end}.A, 1);
...
analysis_indentified_idss = idss(iden_online_result_struct{end}.A, iden_online_result_struct{end}.B, iden_online_result_struct{end}.C, iden_online_result_struct{end}.D, iden_online_result_struct{end}.K, ...
    analysis_x0, para_sim_step, 'NoiseVariance', iden_online_result_struct{end}.cov_all(analysis_identified_x_size+1:analysis_identified_x_size+analysis_y_size, analysis_identified_x_size+1:analysis_identified_x_size+analysis_y_size));
% 特征值
